...
{
    public class Level3 : PhysicsGameScreen, IDemoScreen
    {
        ...
        private void LoadObstacles()
        {
            ...
            _polygonTexture = ScreenManager.Content.Load<Texture2D>("LevelArt/Level3");
        ...
        public void LoadInchWorm()
        {
            ...
            _winSprite._anchor.Position = new Vector2(0f, 0f);
        ...
        bool wonLevel(Fixture fixtureA, Fixture fixtureB, FarseerPhysics.Dynamics.Contacts.Contact contact)
        {
            ...
            level4 = new Level4();
                ...
                ScreenManager.RemoveScreen(this);
                ScreenManager.AddScreen(level4);
