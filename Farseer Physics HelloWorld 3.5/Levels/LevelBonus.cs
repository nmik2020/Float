...
{
    public class LevelBonus : PhysicsGameScreen, IDemoScreen
    {
        ...
        private Body _whacker;
        private Sprite _whackerSprite;
        ...
        private void LoadObstacles()
        {
            ...
            */
            ...
            //Create a whacker physics object
            _whacker = BodyFactory.CreateRectangle(World, 5f, 0.5f, 1f);
            _whacker.Position = new Vector2(5f,13f);
            _whacker.Restitution = 0.9f;
            _whacker.Friction = 0.5f;

            //var j = JointFactory.CreateRevoluteJoint(World, _whacker, null , new Vector2(0f, 0f), new Vector2(2f, 2f));
            //j.MotorSpeed = MathHelper.PiOver2;
            //j.MaxMotorTorque = 10;
            //j.MotorImpulse = 2;
            //j.MotorEnabled = true;
            // Create whacker sprite

              _whackerSprite = new Sprite(ScreenManager.Assets.TextureFromShape(_whacker.FixtureList[0].Shape,
                                                                           MaterialType.Dots,
                                                                         Color.DarkViolet, 0.8f));
...
// END LEVEL LOADER 
        ...
        bool wonLevel(Fixture fixtureA, Fixture fixtureB, FarseerPhysics.Dynamics.Contacts.Contact contact)
        {
            ...
            level2 = new Level2();
                ...
                ScreenManager.RemoveScreen(this);
                ScreenManager.AddScreen(level2);
        ...
        public override void Draw(GameTime gameTime)
        {
            ...
            ScreenManager.SpriteBatch.Draw(_polygonTexture, ConvertUnits.ToDisplayUnits(_compound.Position), null, Color.Tomato, _compound.Rotation, _origin, _scale, SpriteEffects.None, 0f);
           ScreenManager.SpriteBatch.Draw(_whackerSprite.Texture, ConvertUnits.ToDisplayUnits(_whacker.Position),
                                       null,
                                       Color.White, _whacker.Rotation, _whackerSprite.Origin, 1f,
