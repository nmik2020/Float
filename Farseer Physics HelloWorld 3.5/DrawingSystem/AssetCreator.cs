...
namespace FarseerPhysics.Samples.DrawingSystem
{
    ...
    public class AssetCreator
    {
        ...
        public void LoadContent(ContentManager contentManager)
        {
            ...
            _materials[MaterialType.Pivot] = contentManager.Load<Texture2D>("Materials/Steampunk Pivot Joint2");
            _materials[MaterialType.sideA] = contentManager.Load<Texture2D>("Materials/Steampunk CharacterHero Side A2");
            _materials[MaterialType.sideB] = contentManager.Load<Texture2D>("Materials/Steampunk Character Side B2");
            _materials[MaterialType.boxLong] = contentManager.Load<Texture2D>("Materials/tile");
        ...
        public Texture2D SpiderTexture(MaterialType type)
        {
            return _materials[type];
        }

        public Texture2D BoxTexture(MaterialType type)
        {
            return _materials[type];
        }
