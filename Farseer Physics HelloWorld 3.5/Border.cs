...
namespace FarseerModel
{
    public class Border
    {
        ...
        public Border(World world, ScreenManager screenManager, Camera2D camera)
        {
            ...
            float halfWidth = ConvertUnits.ToSimUnits(screenManager.GraphicsDevice.Viewport.Width)/1.5f ;
            float halfHeight = ConvertUnits.ToSimUnits(screenManager.GraphicsDevice.Viewport.Height)/1.5f ;
