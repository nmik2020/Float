...
namespace FarseerPhysics.Samples.ScreenSystem
{
    ...
    public class BackgroundScreen : GameScreen
    {
        ...
        public override void LoadContent()
        {
            ...
            _backgroundTexture = ScreenManager.Content.Load<Texture2D>("Materials/Background");
           //Level 1 Win State
            if (Globals.currentLevel == 1)
            {
                //_logoTexture = ScreenManager.Content.Load<Texture2D>("Common/logo");
                _backgroundTexture = ScreenManager.Content.Load<Texture2D>("Materials/BackgroundLevel1");
            }
            //Level 2 Win State
